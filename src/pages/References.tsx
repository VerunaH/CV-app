export default function References() {
  return (
    <>
      ...
      <h3 className="heading-wrapper">Osobní doporučení</h3>
      <ul>
        <li>
          <strong>Jakub Kameniar</strong>
          <span className="vertical-separator" />
          UX designer
          <span className="vertical-separator" />
          Ness Czech, s.r.o.
          <br />
          spolupráce na 5 projektech
          <br />
          Tel: 607 286 500
        </li>
        <li>
          <strong>Jakub Vais</strong>
          <span className="vertical-separator" />
          Project manager
          <span className="vertical-separator" />
          Ness Czech, s.r.o.
          <br />
          spolupráce na 3 projektech
          <br />
          Tel: 776 301 588
        </li>
        <li>
